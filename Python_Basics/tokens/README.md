...
A token is the smallest individual unit in a Python program. When Python reads your code, it breaks it down into these tokens to parse and execute it.
...
- Are case-sensitive (e.g., `age`, `Age`, and `AGE` are different identifiers).
- Cannot be a keyword.
...
- **Numeric Literals**: `10` (integer), `3.14` (float), `1 + 2j` (complex)
...
- [Official Python Docs — Lexical Analysis Tokens](https://docs.python.org/3/reference/lexical_analysis.html#tokens)
